...
<main class="div-main-ejercicios">
	...
	<form name ="formulario1"> <h3>EJERCICiO 1</h3><br><br>

    <label>Ingresar el número</label><br><br>
		<input name="number" id="numero"><br><br>
		<br>
	<label>Ingresar la base</label><br><br>
		<input name="number" id="base"><br><br>
		<br>
		<input type="button" value="Convertir" onclick="Convertir()">
		<br><br>

	<span id="escondido"></span>
	<br>
