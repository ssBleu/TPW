...
<head>
	...
	<script type="text/javascript" src="js/validar4.js"></script>
...
<body style="text-align: center;">
	...
	<form method="post" action="proceso4.php" id="formu4" target="salida">

		<fieldset>
			<legend><h1>Verificar Triángulo y Calcular Área</h1></legend>

		<label>Lado 1 del triángulo:</label>
		<input type="text" name="Lado1" id="num1" value=""><br><br>
		<label>Lado 2 del triángulo:</label>
		<input type="text" name="Lado2" id="num2" value=""><br><br>
		<label>Lado 3 del triángulo:</label>
		<input type="text" name="Lado3" id="num3" value=""><br><br>

		<input type="submit" name="calcular" value="Verificar"><br><br>

	</form>

		<iframe src="" name="salida" width="300px" height="350px"></iframe>
