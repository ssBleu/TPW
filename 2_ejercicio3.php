...
<body style="text-align: center;">
	...
	<form method="post" action="proceso3.php" id="formu3" target="salida">

		<fieldset>
			<legend><h1>Calcular MCM</h1></legend>

		<label>Numero 1:</label>
		<input type="text" name="nro1" id="num1" value=""><br><br>
		<label>Numero 2:</label>
		<input type="text" name="nro2" id="num2" value=""><br><br>
		<label>Numero 3:</label>
		<input type="text" name="nro3" id="num3" value=""><br><br>

		<input type="submit" name="calcular" value="Calcular MCM"><br><br>
